...
function Accordian() {
  return (
    <div>
      <h1 style={{ textAlign: "center", marginTop: "7%" }}>Frequently Asked Questions</h1>
      <div className="accordion" id="accordionExample" style={{ padding: "4% 0px", width: "80%", maxWidth: '800px', margin: "0 auto" }}>
